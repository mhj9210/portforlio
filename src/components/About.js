        ...
        <div className="row m-auto">
          <div className="col-md-12">
            <div className="about_head">
              ...
              <h4>
                My name is Joshua Min and I would like for you to get to know me
                a little bit.
              </h4>
            </div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 mb-4 mb-md-0">
                    ...
                    <h3>
                      ...
                      developer journey and I love every single moment of it.
                      I'm always open to join a team with great people and move
